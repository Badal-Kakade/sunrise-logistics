...
import { loginUser } from '../redux/slices/authSlice'; // async thunk
    ...
    <View style={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <View>
          ...
          {auth.setPass ? <TouchableOpacity style={styles.button} onPress={handleSetPassword}>
...
const styles = StyleSheet.create({
  container: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#d9117e', paddingTop: StatusBar.currentHeight || 0},
  logo: { width: 250, // Adjust size
    height: 100, resizeMode: 'contain', // Ensure it fits properly
  },
